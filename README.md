...
Расширение добавляет кнопку **«Скачать на NAS»** на странице раздачи торрентов на `rutracker.org`. При нажатии на кнопку `.torrent` файл автоматически передаётся на ваш сервер, где должен быть запущен **qbittorrent-nox**.
